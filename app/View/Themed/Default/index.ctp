<div>
	<div>
		...
		<div class="filter-result-box alert alert-info" >
			...
			<?php endif; ?>
			<?php if(!empty($search_args['search_profile'])): ?>
			<strong>Profile: </strong><span><?php echo $search_args['search_profile']; ?></span>
			<?php endif; ?>
		...
		<div class="filter-box" style="display:none">
			...
			<legend>Filters</legend>
				...
				<?php echo $this->Form->input('search_profile',array('div'=>false,'class'=>'span2','label'=>'profile ','placeholder'=>'profile')); ?>
...
<a href="http://localhost/report/contacts">Export Excel</a>