...
<html lang="en">
  <head>
    ...
    <?php
        ...
        echo $this->Html->script('jquery.ui.autocomplete.min');
	...
	var autoCompleteCompany = function(){
	    $( "#ContactCompany" ).autocomplete({
		    source: function (request, response) {
		        $.getJSON("<?php echo $this->base; ?>/contacts/autocomplete.json?term=" + request.term , function (data) {
		            response($.map(data.resCompany, function (value, key) {
		                return {
		                    label: value,
		                    value: key
		                };
