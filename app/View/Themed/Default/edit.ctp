<div class="edit-contact-container">
	...
	<?php echo $this->Form->input('industry',array('type'=>'text','class'=>'input-xlarge')); ?>
	<?php echo $this->Form->input('address',array('type'=>'textarea','class'=>'input-xlarge')); ?>
	<?php echo $this->Form->input('city',array('type'=>'text','class'=>'input-xlarge')); ?>
	<?php echo $this->Form->input('mobile',array('type'=>'text','class'=>'input-xlarge')); ?>
